...
Single-file frontend app suitable for first-year project and presentation.
Features:
- Add student (Roll No, Name, Age, Course, Marks)
...
- Save this file as student_management_tkinter.py and run: python student_management_tkinter.py

Author: Your Team (modify the header as needed for submission)
"""
